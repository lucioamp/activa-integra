...
CREATE TABLE `ae_usuario_aplicacao_cache` (
  `id_usuario_aplicacao` int(11) NOT NULL,
  `conteudo` blob,
...
INSERT INTO `ae_usuario_aplicacao` VALUES (2,0,25,54,2,'',NULL,NULL,NULL,NULL),(3,2,25,54,2,'Favoritos',NULL,NULL,NULL,NULL),(4,2,1,64,2,'',2,NULL,'lucioamp','7321007a');
...
-- Dump completed on 2010-07-17 21:50:48
