...
INSERT INTO `ae_usuario_aplicacao` (`id_usuario_aplicacao`,`pk_usuario`,`id_aplicacao`,`id_recurso`,`permissao`,`mostrar_janela`,`atualizacao_automatica`,`tempo_valor`) VALUES 
 (2,0,25,54,2,'',NULL,NULL);
/*!40000 ALTER TABLE `ae_usuario_aplicacao` ENABLE KEYS */;


--
-- Definition of table `ae_usuario_aplicacao_parametro`
--
...
INSERT INTO `ae_usuario_aplicacao_parametro` (`id_usuario_aplicacao`,`id_parametro`,`valor_padrao`,`bloquear_valor`) VALUES 
 (1,23,'',0),
 (1,24,'a',0),
 (2,23,'',0),
 (2,24,'a',0);
...
INSERT INTO `favorito` (`pk_favorito`,`no_link`,`ds_link`,`no_url`,`fk_membro`,`fk_pasta`) VALUES 
 (1,'youtube','','http://www.youtube.com',2,1),
