...
--
-- Host: localhost    Database: baliu02
-- ------------------------------------------------------
...
CREATE TABLE `ae_usuario_aplicacao_log` (
  ...
  CONSTRAINT `ae_usuario_aplicacao_log_usuario_aplicacao_fk` FOREIGN KEY (`id_usuario_aplicacao`) REFERENCES `ae_usuario_aplicacao` (`id_usuario_aplicacao`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `ae_usuario_aplicacao_parametro` VALUES (3,23,'1',1),(3,24,'2',0),(4,43,'1',0),(6,43,'2',0);
...
CREATE TABLE `ae_usuario_aplicacao_cache` (
  ...
  CONSTRAINT `ae_usuario_aplicacao_cache_usuario_aplicacao_fk` FOREIGN KEY (`id_usuario_aplicacao`) REFERENCES `ae_usuario_aplicacao` (`id_usuario_aplicacao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ae_usuario_aplicacao_cache` VALUES (4,'Aplica&ccedil;&atilde;o [Delicious - Listar Posts] retornou novos dados:<br/><br/><html><head><META http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><title>tree.xslt output</title><link type=\"text/css\" rel=\"stylesheet\" href=\"tree-view.css\"></head><body><br><span class=\"connector\">&nbsp;&nbsp;</span>|<br><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">___</span>&nbsp;<span class=\"name\">posts</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">count</span> = <span class=\"value\">1</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">start</span> = <span class=\"value\">0</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">tag</span> = <span class=\"value\"></span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">total</span> = <span class=\"value\">10</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">update</span> = <span class=\"value\">2010-11-02T01:05:30Z</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">user</span> = <span class=\"value\">lucioamp</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">___</span>&nbsp;<span class=\"value\">&nbsp;&nbsp;</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span>|<span class=\"connector\">___</span>&nbsp;<span class=\"name\">post</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">description</span> = <span class=\"value\">Teste</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">extended</span> = <span class=\"value\"></span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">hash</span> = <span class=\"value\">2369227b258776589623f488344a8ea0</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">href</span> = <span class=\"value\">http://www.teste.com.br/</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">meta</span> = <span class=\"value\">2661e27635f4128d456aa0190eed36ae</span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">tag</span> = <span class=\"value\"></span><br><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;&nbsp;</span><span class=\"connector\">&nbsp;&nbsp;</span><span class=\"connector\">\\___</span>&nbsp;<span class=\"name\">time</span> = <span class=\"value\">2010-11-02T01:05:30Z</span><br></body></html>');
...
INSERT INTO `ae_aplicacao` VALUES (1,'Delicious','http://www.delicious.com',1,1,'2010-02-10 00:00:00',1,0,0),(2,'Twitter','http://www.twitter.com',1,1,'2010-02-10 00:00:00',0,0,0),(22,'Teste','http://localhost:8080/activa/wadl/delicious.wadl',1,NULL,'2010-05-18 00:00:00',0,0,1),(23,'Teste','http://localhost:8080/activa/wadl/delicious.wadl',1,NULL,'2010-05-18 00:00:00',0,0,1),(24,'Teste','http://localhost:8080/activa/wadl/delicious.wadl',1,NULL,'2010-05-18 00:00:00',1,0,0),(25,'Teste','http://localhost:8080/activa/wadl/delicious.wadl',1,NULL,'2010-05-18 00:00:00',1,0,0);
...
CREATE TABLE `ae_usuario_aplicacao` (
  ...
  CONSTRAINT `ae_aplicacao_fk` FOREIGN KEY (`id_aplicacao`) REFERENCES `ae_aplicacao` (`id_aplicacao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ae_recurso_fk` FOREIGN KEY (`id_recurso`) REFERENCES `ae_recurso` (`id_recurso`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `ae_usuario_aplicacao` VALUES (3,2,25,54,2,'Favoritos',NULL,NULL,NULL,NULL),(4,2,1,64,2,'',2,NULL,'lucioamp','7321007a'),(6,2,1,64,1,'',NULL,NULL,'','');
...
CREATE TABLE `ae_usuario_aplicacao_log_parametro` (
  ...
  CONSTRAINT `ae_usuario_aplicacao_log_parametro_fk` FOREIGN KEY (`id_parametro`) REFERENCES `ae_parametro` (`id_parametro`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ae_usuario_aplicacao_log_fk` FOREIGN KEY (`id_usuario_aplicacao_log`) REFERENCES `ae_usuario_aplicacao_log` (`id_usuario_aplicacao_log`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-01-03 22:23:16
