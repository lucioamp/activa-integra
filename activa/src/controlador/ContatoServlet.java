		...
		switch(opcao)
		{
			...
			case 'D': //Detalhe
			{
				...
				if(tipo.equals("altetar"))
					...
					request.getRequestDispatcher("pages/administrador/servicos/contato/alterar.jsp").forward(request, response);				
				else if(tipo.equals("paginaDetalhe"))
					request.getRequestDispatcher("pages/administrador/servicos/contato/detalhe.jsp").forward(request, response);
				break;
			}
