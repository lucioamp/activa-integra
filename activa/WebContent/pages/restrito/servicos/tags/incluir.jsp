		...
		modulo_ready = function($this, $oldPage, $mainPage) {
			...
			$this.find('button#incluir').click(function() {
				...
				var tdNome = $('<td></td>').html($('<a href="#"></a>').html(nome.val()).click(function(e) {
					e.preventDefault();
					$mainPage.newPage('../../MembroTagServlet?opcao=D', {id: id, nome: nome.val(), desc: desc.val(), tipo: "paginaDetalhe"});
				}));
				...
				tr.contextMenu({
					...
					$mainPage.newPage('../../MembroTagServlet?opcao=D', {id: id, nome: nome.val(), desc: desc.val(), tipo: "paginaDetalhe"});
						...
						Editar: {
							icon: "edit",
							onClick: function() {
								$mainPage.newPage('../../MembroTagServlet?opcao=D', {id: id, nome: nome.val(), desc: desc.val(), tipo: "paginaAlterar"});
							}
						},
						Remover: {
							icon: "delete",
