	...
	$(function() {
		modulo_ready = function($this, $oldPage, $mainPage) {
			...
			$this.find('#alterar').click(function (e) {
				...
				$this.sendRequest('../../TagServlet?opcao=D', {id: id, nome: nome, desc: desc, tipo: 'alterar'}, function(data) {
					for (var i in object['tags'])
					{
						if(object['tags'][i].id == id)
						{
							...
							object['tags'][i].trReferencia.find('td:first').html(nome);
...
<table>
	<tbody>
		...
		<tr>
			...
			<td><textarea id="ds_tag" name="ds_tag"><%= request.getParameter("desc") %></textarea></td>
		</tr>
	</tbody>
	<tfoot>
		<tr>
