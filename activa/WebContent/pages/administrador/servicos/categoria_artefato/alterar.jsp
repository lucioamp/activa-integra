	...
	$(function() {
		modulo_ready = function($this, $oldPage, $mainPage) {
			...
			$this.find('button#alterar').click(function() {
				...
				$this.sendRequest('../../CategoriaArtefatoServlet?opcao=A',
					{pkCategoria: <%= categoria.getPkCatArtefato() %>, nome: nome.val(), descricao: desc.val()},
...
<div id="title">Alterar Categoria de Artefato</div>
